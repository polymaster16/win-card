    ...
    async function pay(){
       // console.log(phoneNumber)
        ...
        try {
          ...
          .catch((err)=>{
           alert("An error occur, try again later. ", err)
           window.location.href = 'https://www.comictu.com/'
          })
...
{     !loading ?     
  <button onClick={()=>pay()} class='p-2 bg-blue-600 rounded-sm mt-4 font-bold'>CLICK ON THIS BUTTON</button>
    :   <button class='p-2 bg-blue-600 rounded-full mt-4 font-bold spins p-2'>🗳️</button>
